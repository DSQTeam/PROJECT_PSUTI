...
public class Mole : MonoBehaviour {
  ...
  [SerializeField] private GameObject hole;
    ...
    private Vector2 startPosition2 = new Vector2(0f, -1.5f);

    private Vector2 endPosition = Vector2.zero;
  // How long it takes to show a mole.
  private float showDuration = 0.55f;
  ...
  private IEnumerator ShowHide(Vector2 start, Vector2 end) {
    ...
    hole.transform.localPosition = startPosition2;
    ...
    while (elapsed < showDuration) {
            ...
            hole.transform.localPosition = Vector2.Lerp(hole.transform.localPosition,end, elapsed / showDuration);
    ...
    hole.transform.localPosition = end;
  ...
  public void Hide() {
    ...
    public void HideHole(Vector2 start, Vector2 end) 
    {
        float elapsed = 0f;
        hole.transform.localPosition = Vector2.Lerp(end, hole.transform.localPosition, elapsed / showDuration);
        hole.SetActive(false);
  ...
  private void SetLevel(int level) {
    ...
    float durationMin = Mathf.Clamp(1.5f - level * 0.025f, 0.01f, 1.5f);
    float durationMax = Mathf.Clamp(4 - level * 0.025f, 0.01f, 4f);
